...
class ItemHandlerTest(TestCase):
    ...
    def test_add_item_correctly(self):
        ...
        item_id = self.item_handler.add_item(name, price, category, shop, description, attributes, session_id)
    ...
    def test_add_item_with_unknown_session_id(self):
        ...
        with self.assertRaises(UserSessionIdNotFoundError):
            self.item_handler.add_item('ItemName', 42.42, 'Category', '5f7c28c6e979c6a33a1f3f79', 'description', {}, 'otherSessionId')
